+++
title = "quant-cache"
description = "Economic CDN cache optimisation — knapsack-based admission, trace replay, and multi-policy comparison ($/period objective)."
template = "project-page.html"
weight = 4

[extra]
category = "CDN / Optimisation"
status = "Active"
featured = true
